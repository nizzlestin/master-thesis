...
import {TestChart} from "./js/TestChart";
...
$(document).ready(() => {
    ...
    d3.json(asset).then((data) => {
        ...
        loc = new TestChart("#loc-container", res, {'metric': 'Code'});
        ...
        // locvscomments = new TestChart("#ratio-container", res, {'metric': 'ltocratio'});
        // complexity = new TestChart("#complexity-container", res, {'metric': 'Complexity'});
    })
})
